...
@CucumberOptions(features = "src/test/resources/feature/Vacation Packages/TestCase1.feature",glue = { "com.stepdefinition" }, plugin = {
		"com.resources.ExtentCucumberFormatter:"},dryRun=false )

public class TestRunnerVacationPackageStarRatings {
